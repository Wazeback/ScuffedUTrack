                ...
                <form method='POST' className='min-w-[360px] max-w-[520px] flex flex-row absolute bg-dark rounded-md'>
                    <div className='flex flex-row '>
                        ...
                        <div className='flex flex-col p-5 rounded-md'>
                            ...
                            <input type='text' placeholder='Titel' className='w-full h-[24px] mb-3 rounded-md text-color bg-input border border-gray-600'/>

                            <textarea placeholder='Omschrijving' className='w-full min-h-[140px] max-h-[140px] mb-3 whitespace-normal break-all rounded-md text-color bg-input border border-gray-600'/>

                            <div className='flex flex-row mb-4'>
                                <span className='text-sm text-color'>Estimation</span>
                                {/*TODO: alleen maar "valid" inputs (1m-1h-1d-1w)*/}
                                <input type='text' placeholder='1m 1h 1d 1w' className='w-[85px] ml-1 pl-0 rounded-md text-sm text-color bg-input border border-gray-600'/>
                            ...
                            <div>
                                ...
                                <button className='px-2 rounded-md text-[#aaacb2;] bg-input border border-gray-600'>Toevoegen</button>
